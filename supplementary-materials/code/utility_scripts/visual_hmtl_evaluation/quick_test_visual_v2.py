...
class VisualHMTLClassifierV2(nn.Module):
    """Visual HMTL V2 分类器"""
...
def main():
    ...
    # 3. 加载模型
    model_path = r"d:\bigcreate\06_模型文件\visual_hmtl_v2_best.pt"
    ...
    print("="*60)
    print(f"         V1        V2")
    print(f"4类:    55.3%  →  {acc_4*100:.1f}%")
    print(f"3类:    71.7%  →  {acc_3*100:.1f}%")
    print(f"7类:    52.3%  →  {acc_7*100:.1f}%")
