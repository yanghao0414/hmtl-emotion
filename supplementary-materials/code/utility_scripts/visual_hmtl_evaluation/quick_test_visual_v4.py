...
def load_model(model_path, device):
    ...
    if 'model_state_dict' in state_dict:
        ...
        if 'score' in state_dict:
            print(f"训练时综合分数: {state_dict['score']}")
...
def main():
    ...
    for label_id in range(4):
        ...
        if sum(mask) > 0:
            ...
            class_acc_4[label_id] = class_acc
    ...
    # V1 vs V2 vs V3 vs V4 对比
    print("\n" + "="*60)
    print("V1 vs V3 vs V4 对比")
    print("="*60)
    print(f"              V1        V3        V4")
    print(f"4类:        55.3%     57.5%  →  {acc_4*100:.1f}%")
    print(f"3类:        71.7%     72.0%  →  {acc_3*100:.1f}%")
    print(f"7类:        52.3%     56.5%  →  {acc_7*100:.1f}%")
    print(f"\n非激活消极:  42.0%     24.0%  →  {class_acc_4.get(2, 0)*100:.1f}%")
